...
const DashboardSidebar = () => {
  return (
    <div className="xl:w-[400px] bg-gray-500 h-full max-xl:w-full">
      <Link href="/admin">
        <div className="flex gap-x-2 w-full hover:bg-gray-600 cursor-pointer items-center py-6 pl-5 text-xl text-white">
